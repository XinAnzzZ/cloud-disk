...
public class ShiroUtils {
    ...
    public static String toMD5(String credentials, String salt) {
        String hashAlgorithmName = PropertyUtils.getProperty("shiro.hashAlgorithmName");
        int hashIterations = Integer.parseInt(PropertyUtils.getProperty("shiro.hashIterations"));
